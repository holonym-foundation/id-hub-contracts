...
async function run () {
    ...
    Proofs.onAddLeaf({
        pubKeyX: Issuer.frToBigInt(creds.pubkey[0]),
        pubKeyY: Issuer.frToBigInt(creds.pubkey[1]),
        R8x: Issuer.frToBigInt(creds.signature.r_b8[0]),
        R8y: Issuer.frToBigInt(creds.signature.r_b8[1]),
        S: Issuer.frToBigInt(creds.signature.s),
        ...
        signedLeaf: Issuer.frToBigInt(creds.leaf), //originalLeaf.digest,
